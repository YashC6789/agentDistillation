...
def parse_args():
    ...
    p.add_argument("--dataset_file", default="/storage/ice1/4/7/araj72/agentDistillation/gsm8k_qwen72b_gold_trajectories_h200.jsonl")
    p.add_argument("--output_dir", default="/storage/ice1/4/7/araj72/agentDistillation/grpo_qwen3_0_6b")
...
def main():
    ...
    def reward_func(completions, answer, **kwargs):
        ...
        for completion, gt in zip(completions, answer):
            ...
            acc_reward = 2.0 if pred == gt else 0.0
            format_reward = 0.2 if ("Final Answer" in completion or "####" in completion) else -0.2
            length_penalty = 0.0005 * len(completion.split())
