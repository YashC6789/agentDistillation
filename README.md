...
- `trajectories/gsm8k_qwen72b_sample_golden_trajectories.jsonl` → small (~300 samples, testing)
- `trajectories/gsm8k_qwen72b_final_trajectories.jsonl` → full dataset (~7k samples, best results)
...
--dataset_file gsm8k_qwen72b_final_trajectories.jsonl
...
python train_sft.py
--model_name Qwen/Qwen3-0.6B
--dataset_file trajectories/gsm8k_qwen72b_final_trajectories.jsonl
